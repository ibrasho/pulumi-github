...
func NewProjectColumn(ctx *pulumi.Context,
	...
	inputs["etag"] = nil
	s, err := ctx.RegisterResource("github:index/projectColumn:ProjectColumn", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetProjectColumn(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("github:index/projectColumn:ProjectColumn", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &ProjectColumn{s: s}, nil
