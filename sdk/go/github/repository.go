...
func NewRepository(ctx *pulumi.Context,
	...
	inputs["svnUrl"] = nil
	s, err := ctx.RegisterResource("github:index/repository:Repository", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetRepository(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("github:index/repository:Repository", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &Repository{s: s}, nil
