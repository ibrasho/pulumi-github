...
func NewRepositoryDeployKey(ctx *pulumi.Context,
	...
	inputs["etag"] = nil
	s, err := ctx.RegisterResource("github:index/repositoryDeployKey:RepositoryDeployKey", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &RepositoryDeployKey{s: s}, nil
}
...
func GetRepositoryDeployKey(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("github:index/repositoryDeployKey:RepositoryDeployKey", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &RepositoryDeployKey{s: s}, nil
...
func (r *RepositoryDeployKey) URN() *pulumi.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *RepositoryDeployKey) ID() *pulumi.IDOutput {
	return r.s.ID()
}

func (r *RepositoryDeployKey) Etag() *pulumi.StringOutput {
	return (*pulumi.StringOutput)(r.s.State["etag"])
}

// A ssh key.
func (r *RepositoryDeployKey) Key() *pulumi.StringOutput {
...
// A title.
func (r *RepositoryDeployKey) Title() *pulumi.StringOutput {
