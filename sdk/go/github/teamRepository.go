...
func NewTeamRepository(ctx *pulumi.Context,
	...
	inputs["etag"] = nil
	s, err := ctx.RegisterResource("github:index/teamRepository:TeamRepository", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &TeamRepository{s: s}, nil
}
...
func GetTeamRepository(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("github:index/teamRepository:TeamRepository", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &TeamRepository{s: s}, nil
