...
class GetUserResult:
    ...
    """
    def __init__(__self__, avatar_url=None, bio=None, blog=None, company=None, created_at=None, email=None, followers=None, following=None, gpg_keys=None, gravatar_id=None, location=None, login=None, name=None, public_gists=None, public_repos=None, site_admin=None, ssh_keys=None, updated_at=None, username=None, id=None):
