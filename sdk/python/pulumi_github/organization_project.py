...
class OrganizationProject(pulumi.CustomResource):
    ...
    URL of the project
    """
    def __init__(__self__, resource_name, opts=None, body=None, name=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, body=None, etag=None, name=None, url=None):
        """
