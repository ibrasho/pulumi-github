...
class Provider(pulumi.ProviderResource):
    def __init__(__self__, resource_name, opts=None, base_url=None, individual=None, insecure=None, organization=None, token=None, __props__=None, __name__=None, __opts__=None):
        """
